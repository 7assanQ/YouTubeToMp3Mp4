...
def on_progress(stream, chunk, bytes_remaining):
    ...
    if language:
        download_number_1.config(text= 'تحميل: ' + percentage + '%') 
...
button_4 = tk.Button(app, text='عربي\nEnglish', font=('Arial', 10), background ='dark red', foreground= 'white', command = change_language)
...
def update_download_number():
    return f"Loading: {download_bar_1['value']}%"
